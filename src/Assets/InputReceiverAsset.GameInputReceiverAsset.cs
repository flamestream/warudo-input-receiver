...
namespace FlameStream
{
    ...
    public class GameInputReceiverAsset : InputReceiverAsset {
        ...
        protected override void OnGeneratedProfileSelectionChange(SignalTemplateType profile) {
            base.OnGeneratedProfileSelectionChange(profile);
            if (profile == SignalTemplateType.SwitchProController) {
                SignalDefinitionGenerationSectionInstance.SignalDefinitionGenerationFromTemplateSectionInstance.SetProfileDescription("CONTROLLER_NINTENDO_SWITCH_PRO_GAMEINPUT_PROFILE_WARNING".Localized());
            } else {
                SignalDefinitionGenerationSectionInstance.SignalDefinitionGenerationFromTemplateSectionInstance.SetProfileDescription(null);
            }
        }
        ...
        protected override SignalTemplateType[] SupportedProfileTypes {
            get {
                return new SignalTemplateType[] {
                    ...
                    SignalTemplateType.XboxSeriesXSController,
                };
            }
        }
        ...
        protected override void GenerateButtonDefinitions(SignalTemplateType profile) {
            ...
            if (profile == SignalTemplateType.SwitchProController) {
                buttonDefinitions.Add(StructuredData.Create<ButtonDefinition>(d => {
                    d.IsValid = true;
                    d.Index = 12;
                    d.Label = "Home";
            ...
            SetDataInput(nameof(ButtonDefinitions), buttonDefinitions.ToArray(), true);
                ...
                new SwitchDefinition[] {
                    StructuredData.Create<SwitchDefinition>(d => {
                        ...
                        if (profile != SignalTemplateType.SwitchProController) {
                            ...
                            d.VirtualDefinitionSet.UpId = 6;
                            d.VirtualDefinitionSet.DownId = 7;
                            d.VirtualDefinitionSet.LeftId = 8;
                            d.VirtualDefinitionSet.RightId = 9;
                        }
                    }),
                },
                true
            ...
            var axisDefinitions = new List<AxisDefinition> {
            ...
            if (profile != SignalTemplateType.SwitchProController) {
                axisDefinitions.Add(StructuredData.Create<AxisDefinition>(d => {
                    d.IsValid = true;
                    d.Index = 4;
                    d.Label = "LT";
                    d.AssignedCharacterLayer = Layer.LeftMiddle;
            ...
            SetDataInput(nameof(AxisDefinitions), axisDefinitions.ToArray(), true);
